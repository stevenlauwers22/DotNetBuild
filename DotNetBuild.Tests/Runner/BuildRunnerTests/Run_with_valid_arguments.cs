...
{
    public class Run_with_valid_arguments
        : TestSpecification<BuildRunner>
    {
        ...
        protected override void Arrange()
        {
            ...
            _parameters = new[] { TestData.GenerateString(), TestData.GenerateString() };
        ...
        {
            _targetExecutor.Verify(te => te.Execute(_target.Object, _configurationSettings.Object, It.IsAny<IParameterProvider>()));
        }
    }
}
...
{
    public class When_told_to_Run_with_no_target
        : TestSpecification<BuildRunner>
    {
        ...
        {
            _exception = TestHelpers.CatchException<UnableToFindTargetException>(() => Sut.Run(_assemblyName, _targetName, _configurationName));
        }

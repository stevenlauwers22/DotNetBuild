...
{
    public class When_told_to_Run_with_no_configurator
        : TestSpecification<BuildRunner>
    {
        ...
        {
            _exception = TestHelpers.CatchException<UnableToResolveConfiguratorException>(() => Sut.Run(_assemblyName, _targetName, _configurationName));
        }
